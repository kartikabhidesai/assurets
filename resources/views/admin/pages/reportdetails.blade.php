                    ...
                    <div id="rickshaw_scatterplot" class="rickshaw_graph">
                        ...
                        <div class="table-responsive">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td colspan="3">Ref No : {{ $reportdata->reference_no }}</td>
                                    <td colspan="3"></td>
                                    <td colspan="3"></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="4"></td>
                                    <td colspan="3"><h3>Inspection Details</h3></td>
                                    <td colspan="2"></td>
                                    <td colspan="3"></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="4"></td>
                                    <td colspan="3"><h3>Registration Details</h3></td>
                                    <td colspan="2"></td>
                                    <td colspan="3"></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="4"></td>
                                    <td colspan="3"><h3>Condition</h3></td>
                                    <td colspan="2"></td>
                                    <td colspan="3"></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td colspan="6"><h3>Accessories found at the time of inspection</h3></td>
                                    <td colspan="2"></td>
                                    <td colspan="1"></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td colspan="6"><h3>Overall condition of the vehicle</h3></td>
                                    <td colspan="2"></td>
                                    <td colspan="1"></td>
                                    <td></td>
                                </tr>
