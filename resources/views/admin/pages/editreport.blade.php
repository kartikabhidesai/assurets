                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="reportform" action="">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" name="fullname" class="form-control" value="{{ $reportdata->fullname }}">
                        	</div>
                        </div> 
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" name="detail_line_1" class="form-control" value="{{ $reportdata->detail_line_1 }}">
                        	</div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" name="detail_line_2" class="form-control" value="{{ $reportdata->detail_line_2 }}">
                        	</div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-3">
                        		<input type="text" name="licence_no" class="form-control" value="{{ $reportdata->licence_no }}">
                        	</div>
                        	<label class="col-sm-2 control-label">Expiry Date</label>
                        	<div class="col-sm-3">
                        		<input type="date" name="expriry_date" class="form-control" value="{{ date('Y-m-d',strtotime($reportdata->expriry_date)) }}">
                        	</div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" name="iiisla_no" class="form-control" value="{{ $reportdata->detail_line_1 }}">
                        	</div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" name="iiv_no" class="form-control" value="{{ $reportdata->detail_line_1 }}">
                        	</div>
                        </div>
						<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" name="ce_a_no" class="form-control" value="{{ $reportdata->detail_line_1 }}">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" name="address_1" class="form-control" value="{{ $reportdata->detail_line_1 }}">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->address_2 }}" name="address_2" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->city }}" name="city" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->phone_fax }}" name="phone_fax" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="email" name="email" class="form-control" value="{{ $reportdata->email }}">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->reference_no }}" name="reference_no" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="date" name="date" class="form-control" value="{{ date('Y-m-d',strtotime($reportdata->date)) }}">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->to }}" name="to" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="date" name="inspection_date" class="form-control" value="{{ date('Y-m-d',strtotime($reportdata->inspection_date)) }}">
                    		</div>
                    	</div>
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->inspected_at }}" name="inspected_at" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->inspected_at_stockyard }}" name="inspected_at_stockyard" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="time" name="inspection_time" class="form-control" value="{{ $reportdata->inspection_time }}">
                    		</div>
                    	</div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->registration_no }}" name="registration_no" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->registred_owner_name_add }}" name="registred_owner_name_add" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->proposed_owner_name_add }}" name="proposed_owner_name_add" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->engine_no }}" name="engine_no" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->chassis_no }}" name="chassis_no" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->color }}" name="color" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->odo_meter_reading }}" name="odo_meter_reading" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->hours_reading }}" name="hours_reading" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->owner_serial_number }}" name="owner_serial_number" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->hypothecation_details }}" name="hypothecation_details" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->class_of_vehical }}" name="class_of_vehical" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->nanufacture }}" name="nanufacture" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->model }}" name="model" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->fuel }}" name="fuel" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->month_year_manufactureing }}" name="month_year_manufactureing" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->date_of_registration }}" name="date_of_registration" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-6">
                        		<input type="text" value="{{ $reportdata->re_registration_no }}" name="re_registration_no" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-6">
                        		<input type="text" value="{{ $reportdata->reassigned_no }}" name="reassigned_no" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->tax_paid_upto }}" name="tax_paid_upto" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-8">
                        		<input type="date" name="vehicle_fitness" class="form-control" value="{{ date('Y-m-d',strtotime($reportdata->vehicle_fitness)) }}">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-8">
                        		<input type="date" name="vehicle_permit" class="form-control" value="{{ date('Y-m-d',strtotime($reportdata->vehicle_permit)) }}">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->rc }}" name="rc" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-8">
                        		<input type="text" value="{{ $reportdata->condition }}" name="condition" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->reregistered }}" name="reregistered" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-10">
                        		<input type="text" value="{{ $reportdata->seized }}" name="seized" class="form-control">
                    		</div>
                    	</div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_engine }}" name="con_engine" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Lights and Electrical</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_light_electrical }}" name="con_light_electrical" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_cabin }}" name="con_cabin" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Chassis</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_chassis }}" name="con_chassis" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_battery }}" name="con_battery" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Body Condition</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_body_condition }}" name="con_body_condition" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_paint }}" name="con_paint" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_suspension }}" name="con_suspension" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_tipper }}" name="con_tipper" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Fr. Bumper </label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_fr_bumper }}" name="con_fr_bumper" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_cowl_assy }}" name="con_cowl_assy" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Cowl Panel Lh </label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_cowl_panel }}" name="con_cowl_panel" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	<label class="col-sm-2 control-label">Cowl Panel Lh</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_panel_lh }}" name="con_panel_lh" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Cowl Panel Rh </label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_panel_rh }}" name="con_panel_rh" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_ws_gkasses }}" name="con_ws_gkasses" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Dash Board</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_dashboeard }}" name="con_dashboeard" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_bonnet_centere }}" name="con_bonnet_centere" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_cabin_lhs }}" name="con_cabin_lhs" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Cabin Rhs Structure</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_cabin_rhs }}" name="con_cabin_rhs" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_cabin_top }}" name="con_cabin_top" class="form-control">
                    		</div>
                    	</div>
						<div class="hr-line-dashed"></div>
                        <div class="form-group">
                    	...
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_chassis_frame }}" name="con_chassis_frame" class="form-control">
                    		</div>
                    	</div>
						<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_silencer }}" name="con_silencer" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Manifold</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_manifold }}" name="con_manifold" class="form-control">
                    		</div>
                    	</div>
						<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_engine_assy }}" name="con_engine_assy" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">FIP</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_fip }}" name="con_fip" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_air_cleaner }}" name="con_air_cleaner" class="form-control">
                    		</div>
                    	</div>
						<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_radioter }}" name="con_radioter" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Hoses</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_hoses }}" name="con_hoses" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_fuel_supply }}" name="con_fuel_supply" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Fuel Tank</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_fuel_tank }}" name="con_fuel_tank" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_pipe_lines }}" name="con_pipe_lines" class="form-control">
                    		</div>
                    	</div>
						<div class="hr-line-dashed"></div>
                        <div class="form-group">
                    	...
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_fr_axle }}" name="con_fr_axle" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Rr Axle</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_rr_axle }}" name="con_rr_axle" class="form-control">
                    		</div>
                    	</div>
						<div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_rhs_head_lamp }}" name="con_rhs_head_lamp" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Lhs Head Lamp</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_lhs_head_lamp }}" name="con_lhs_head_lamp" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_tail_cluster }}" name="con_tail_cluster" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Battery Make</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_battery_make }}" name="con_battery_make" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_battery_condition }}" name="con_battery_condition" class="form-control">
                    		</div>
                    	</div>
						<div class="hr-line-dashed"></div>
                        <div class="form-group">
                    	...
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_transmission }}" name="con_transmission" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Gear Box</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_gear_box }}" name="con_gear_box" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_propeller_shft }}" name="con_propeller_shft" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Rear Housing</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_rear_housing }}" name="con_rear_housing" class="form-control">
                    		</div>
                    	</div>
						<div class="hr-line-dashed"></div>
                        <div class="form-group">
                    	...
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_brake_padel }}" name="con_brake_padel" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Brake Booster</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_brake_booster }}" name="con_brake_booster" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_brake_pipes }}" name="con_brake_pipes" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Air Cyl</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_air_cyl }}" name="con_air_cyl" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_governer }}" name="con_governer" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                    	...
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_steering_wheel }}" name="con_steering_wheel" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Steering Box</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_steering_box }}" name="con_steering_box" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_stg_column }}" name="con_stg_column" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Stg. Linkages</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_stg_linkages }}" name="con_stg_linkages" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                    	...
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_fr_suspension }}" name="con_fr_suspension" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Rr.Suspension</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_rr_suspension }}" name="con_rr_suspension" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                    	...
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_lhs_wing }}" name="con_lhs_wing" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Rhs Wing</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_rhs_wing }}" name="con_rhs_wing" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_tail_gate }}" name="con_tail_gate" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Floor</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_floor }}" name="con_floor" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                        <div class="form-group">
                    	...
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_wheel_discs }}" name="con_wheel_discs" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Fr.Rhs Tyre Make</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_fr_rhs_tyre_make }}" name="con_fr_rhs_tyre_make" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_fr_lhs_tyre_make }}" name="con_fr_lhs_tyre_make" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Rr.Rhs.Tyre Make</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_rr_rhs_tyre_make }}" name="con_rr_rhs_tyre_make" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
                        	...
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_rr_lhs_tyre_take }}" name="con_rr_lhs_tyre_take" class="form-control">
                    		</div>
                    		<label class="col-sm-2 control-label">Stepney</label>
                        	<div class="col-sm-4">
                        		<input type="text" value="{{ $reportdata->con_stepney }}" name="con_stepney" class="form-control">
                    		</div>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                    	<div class="form-group">
